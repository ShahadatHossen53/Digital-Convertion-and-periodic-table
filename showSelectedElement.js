...
function create_html_dom_element(){
    details_element_name = createElement("h3", "");
    details_element_number = createElement("h5", "");
    details_element_symbol = createElement("h5", "");
    details_element_group = createElement("h5", ""); 
    details_element_period = createElement("h5", ""); 
    details_element_block = createElement("h5", ""); 
    details_element_weight = createElement("h5", ""); 
    details_element_density = createElement("h5", ""); 
    details_element_melting_point = createElement("h5", ""); 
    details_element_boiling_point = createElement("h5", ""); 
    details_element_specific_heat_capacity = createElement("h5", ""); 
    details_element_e_neg = createElement("h5", ""); 
    details_element_abundance_in_earths_crust = createElement("h5",""); 
    details_element_origin = createElement("h5", ""); 
    details_element_f_ionisation_energie = createElement("h5", ""); 
    details_element_oxidation_states = createElement("h5", "");
    details_element_electron_config = createElement("p", "");
    details_element_phase = createElement("h5", ""); 
}
